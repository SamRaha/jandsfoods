            ...
            <div className="products-block-container">
                ...
                <div className="products-block">
                    ...
                    <div className="products-text-block">
                        <h3>Cafes</h3>
                        <p>
                            Cafes have been J and S’s bread and butter since day one. We are proud to stock some of the best wholesale food goods to meet your café’s needs. Working closely with a diverse range of cafes, we can guarantee we stock what
                            you require.
                        </p>
                        <a href=""></a>
                    </div>
                ...
                <div className="products-block">
                    <div className="products-text-block">
                        ...
                        <p>
                            We pride ourselves on sourcing food goods that many other suppliers cannot provide. Our close working relationships with our suppliers has enabled us to provide an extensive range of vegan and plant based foods. Speciality
                            dietary food products are available from gluten free, lactose free, nut free for example to assist with menu choses.
                        </p>
                        <a href=""></a>
                    </div>
                ...
                <div className="products-block">
                    ...
                    <div className="products-text-block">
                        ...
                        <p>
                            We have been supplying mobile caterers for decades now, from vendors at The Leeds Festival and The Yorkshire Show to food vans at various sporting and music events or speciality vendors in The Trinity Kitchen. Rest assured
                            we can work closely with you to provide food items to meet your businesses needs.
                        </p>
                        <a href=""></a>
                    </div>
                </div>
